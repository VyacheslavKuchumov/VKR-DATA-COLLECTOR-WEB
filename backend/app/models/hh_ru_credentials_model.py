...
class HHRuCredentialsModel(BaseModel):
    ...
    HH_RU_ACCESS_TOKEN: str = Field(
        ..., alias="HH_RU_ACCESS_TOKEN", description="Access token для API hh.ru"
    )
    HH_RU_REFRESH_TOKEN: str = Field(
        ..., alias="HH_RU_REFRESH_TOKEN", description="Refresh token для API hh.ru"
    )
